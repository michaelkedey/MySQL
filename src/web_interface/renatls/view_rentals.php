...
<body>
    ...
    <div class="buttons-container">
        <a href="movies.php" class="button movies-button">Movies</a>
        <a href="subscribers.php" class="button subscribers-button">Subscribers</a>
        <a href="../index.html" class="button home-button"></a>
