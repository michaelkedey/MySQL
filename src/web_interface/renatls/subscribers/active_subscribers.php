...
<body>
    ...
    <div class="buttons-container">
        ...
        <a href="subscriber_rentals.php" class="button subscriber_rentals-button">Subscriber Rentals</a>
        <a href="../view_rentals.php" class="button movie_rentals-button">Rentals</a>
